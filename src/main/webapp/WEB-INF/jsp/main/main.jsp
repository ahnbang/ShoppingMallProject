    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">TerzoBang</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                        ${session.getAttribute("loginMemberName")}
                        <!-- 비회원 접속 -->
                        ...
                        <!-- 회원 접속 -->                       
                        <% if(loginMemberRole != null && loginMemberRole.equals("USER")){ %>
                        ...
                        <!-- 관리자 접속 --> 
                        <% if(loginMemberRole != null && loginMemberRole.equals("ADMIN")){ %>
                            <button type="button" class="btn btn-outline-dark dropdown-toggle" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="true">
